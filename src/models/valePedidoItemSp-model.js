...
const ValePedidoItemSp = sequelize.define('ValePedidoItemSp', {
  ...
  // O que foi digitado no computador pelo vendedor
  quantidadePedida: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },

  // O que realmente foi encontrado e colocado no pacote (usado para o cálculo final e estoque)
